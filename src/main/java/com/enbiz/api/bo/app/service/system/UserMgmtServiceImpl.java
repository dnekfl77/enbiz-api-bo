...
import com.enbiz.api.bo.app.dto.request.system.IndividualInfoRightCudRequest;
import com.enbiz.api.bo.app.dto.request.system.UserCudRequest;
...
import com.enbiz.api.bo.app.repository.main.system.StUserRtGrpMapper;
import com.enbiz.api.bo.app.repository.main.system.StIndInfoQryRtInfoTrxMapper;
...
public class UserMgmtServiceImpl implements UserMgmtService{
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    @CacheEvict(value="personalInfoService", key="#request.userInfo.userId")
    ...
    private void insertUserBase(String currentUser, UserCudRequest userInfoReq) throws Exception {
        ...
        //userParam.setPwd(this.theHandsomePasswordEncoder.encode(userInfoReq.getPwd(), userInfoReq.getUserId()));//ksi 변경
