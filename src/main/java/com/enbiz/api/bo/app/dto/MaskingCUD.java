package com.enbiz.api.bo.app.dto;
...
public class MaskingCUD {
	/*
	 * 성명_한글: userNmKr 성명_영문: userNmEn 생년월일: userBirth 전화번호: userPhoneNum 핸드폰:
	 * userMobileNum 주소: userAddress 상세주소: userAddressDtl IP: userIP 이메일: userEmail
	 * ID: userID 계좌번호: userActn 카드번호: userCard
	 */
