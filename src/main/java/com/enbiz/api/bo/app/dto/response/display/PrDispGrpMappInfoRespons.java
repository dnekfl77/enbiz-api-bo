...
import com.enbiz.api.bo.app.enums.DP011;
import com.enbiz.api.bo.app.enums.DP012;
...
public class PrDispGrpMappInfoRespons extends BaseCommonEntity {
	...
	private String dispGrpTypCd = DP011.REPRESENTATIVE_EXHIBITION.getCd(); // 전시그룹유형코드(DP011)(01:대표기획전) varchar(10) Not
																			// Null
