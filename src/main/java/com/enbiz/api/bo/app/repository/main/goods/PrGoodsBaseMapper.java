...
import com.enbiz.api.bo.app.dto.request.goods.GoodsInfoModificationHistoryRequest;
import com.enbiz.api.bo.app.dto.request.goods.GoodsMgmtRequest;
import com.enbiz.api.bo.app.dto.request.goods.PackageTargetGoodsRequest;
import com.enbiz.api.bo.app.dto.request.goods.WebStockMgmtRequest;
import com.enbiz.api.bo.app.dto.request.popup.GoodsPopupRequest;
import com.enbiz.api.bo.app.dto.response.goods.GoodsBaseResponse;
import com.enbiz.api.bo.app.dto.response.goods.GoodsInfoModificationHistoryResponse;
import com.enbiz.api.bo.app.dto.response.goods.GoodsMgmtResponse;
import com.enbiz.api.bo.app.dto.response.goods.PackageTargetGoodsResponse;
import com.enbiz.api.bo.app.dto.response.goods.ReservationGoodsMgmtResponse;
import com.enbiz.api.bo.app.dto.response.goods.WebStockMgmtResponse;
import com.enbiz.api.bo.app.dto.response.popup.GoodsPopupResponse;
