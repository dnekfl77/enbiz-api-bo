...
import com.enbiz.api.bo.app.dto.request.display.PrConrTgtInfoRequest;
import com.enbiz.api.bo.app.dto.response.display.PrConrTgtInfoResponse;
import com.enbiz.api.bo.app.entity.PrConrSetInfo;
...
public interface PrConrSetInfoMapper {
	 ...
	 * @return
	 */
	void prDispConrInfoInsert(PrConrSetInfoRequest prConrSetInfoRequest);
