...
import com.enbiz.api.bo.app.repository.main.system.StRtGrpBaseMapper;
import com.enbiz.api.bo.app.repository.main.system.StRtTgtBaseMapper;
import com.enbiz.api.bo.app.repository.main.system.StRtGrpBaseTrxMapper;
...
public class RightGroupMgmtServiceImpl implements RightGroupMgmtService {
	...
	public void registRightGroupBase(List<RightGroupBaseRequest> createList) throws Exception {
		...
		for (RightGroupBaseRequest RightGroupBaseRequest : createList) {
			...
			String rtGrpNo = stRtGrpBaseTrxMapper.getRtGrpNo();
			stRtGrpBase.setRtGrpNo(rtGrpNo);
			stRtGrpBaseTrxMapper.insertStRtGrpBase(stRtGrpBase);
			
			stRtGrpBase = new StRtGrpBase();
			stRtGrpBase.setRtGrpNo(rtGrpNo);
			stRtGrpBase.setSysGbCd(RightGroupBaseRequest.getSysGbCd());
			stRtGrpBase.setSysRegId(loginId);
			stRtGrpBase.setSysModId(loginId);
	        stRtInfoTrxMapper.saveStRtInfoSelect(stRtGrpBase);
		}
	}
