...
import com.enbiz.api.bo.app.repository.main.common.AdminCommonBaseTrxMapper;
import com.enbiz.api.bo.app.repository.main.common.StJobCnctInfoMapper;
import com.enbiz.api.bo.app.repository.main.customerservice.CsCustCnslInfoMapper;
import com.enbiz.api.bo.app.repository.main.goods.PrGoodsBaseMapper;
import com.enbiz.api.bo.app.repository.main.goods.PrPregGoodsBaseMapper;
...
//	}
	...
	/**
	 * 이미지 저장 & 리사이징 이미지업로드 & 리사이징 진행을 한다.
	 * 
	 * @return String
	 * @date 2021. 03. 08. 오후 2:37:27
	 * @author N.J.Kim
...
//
	...
	@Override
	@Cacheable(value = "personalInfoService", key = "#userId")
	public Map<String, Object> getPermissionToViewPersonalInfo(String userId) {
		List<PrivacyPolicyInfo> list = stIndInfoQryRtInfoMapper.getStIndInfoQryRtInfoList(userId);

		if (list == null) {
			return null;
		}
		Map<String, Object> permissionMap = new HashMap<String, Object>();
		for (PrivacyPolicyInfo info : list) {
			permissionMap.put(info.getIndInfoGbCd(), info.getUseYn());
		}
