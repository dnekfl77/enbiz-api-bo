...
import com.enbiz.api.bo.app.dto.request.popup.EnEntrBaseRequest;
import com.enbiz.api.bo.app.dto.request.vendor.CooperateSearchRequest;
import com.enbiz.api.bo.app.dto.request.vendor.PartnerSearchRequest;
import com.enbiz.api.bo.app.dto.response.popup.EnEntrBaseResponse;
import com.enbiz.api.bo.app.dto.response.vendor.CooperateAndOthersResponse;
import com.enbiz.api.bo.app.dto.response.vendor.CooperateSearchResponse;
import com.enbiz.api.bo.app.dto.response.vendor.PartnerDeliveryPolicySearchResponse;
import com.enbiz.api.bo.app.dto.response.vendor.PartnerSearchResponse;
...
public interface EtEntrBaseMapper {
	...
	List<PartnerDeliveryPolicySearchResponse> getDeliveryPolicySearchList(PartnerSearchRequest partnerSearchRequest)
			throws Exception;

	int getCooperateSearchListCount(CooperateSearchRequest cooperateSearchRequest) throws Exception;

	List<CooperateSearchResponse> getCooperateSearchList(CooperateSearchRequest cooperateSearchRequest)
			throws Exception;
