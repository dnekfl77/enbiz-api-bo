...
import com.enbiz.api.bo.app.dto.request.customerservice.CsAssignRequest;
import com.enbiz.api.bo.app.dto.request.customerservice.CsAssignRetrieveRequest;
import com.enbiz.api.bo.app.dto.request.customerservice.IntegratedCounselRequest;
import com.enbiz.api.bo.app.dto.response.common.DashboardGoodsQnaIngResponse;
import com.enbiz.api.bo.app.dto.response.customerservice.CsAssignResponse;
import com.enbiz.api.bo.app.dto.response.customerservice.CsCcnOrdGoodsResponse;
import com.enbiz.api.bo.app.dto.response.customerservice.CsCcnProcInfoResponse;
import com.enbiz.api.bo.app.dto.response.customerservice.CsRelatedResponse;
import com.enbiz.api.bo.app.dto.response.customerservice.CsTelPrmsResponse;
import com.enbiz.api.bo.app.dto.response.customerservice.CsTransReqResponse;
import com.enbiz.api.bo.app.dto.response.customerservice.IntegratedCounselResponse;
import com.enbiz.api.bo.app.dto.response.customerservice.IntegratedCsDetailResponse;
import com.enbiz.api.bo.app.entity.CsCustCnslInfo;
...
public interface CsCustCnslInfoTrxMapper {
	 ...
	 * @throws Exception
	 */
	List<IntegratedCounselResponse> integrateCounselingList(IntegratedCounselRequest IntegratedCounselRequest)
			throws Exception;
