...
import com.enbiz.api.bo.app.dto.request.customerservice.CounselingTypePopupRequest;
import com.enbiz.api.bo.app.dto.request.customerservice.CounselingTypeRequest;
import com.enbiz.api.bo.app.dto.response.customerservice.CounselingTypeResponse;
...
public interface CsCnslTypInfoMapper {
	 ...
	 * @throws Exception
	 */
	List<CounselingTypeResponse> getLowerConsultationTypeList(CounselingTypeRequest CounselingTypeRequest)
			throws Exception;
	 ...
	 * @throws Exception
	 */
	List<CounselingTypeResponse> getConsultationTypeListPopup(CounselingTypePopupRequest CounselingTypePopupRequest)
			throws Exception;
