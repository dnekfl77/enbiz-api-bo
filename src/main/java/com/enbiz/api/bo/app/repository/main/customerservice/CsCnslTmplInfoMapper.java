...
import com.enbiz.api.bo.app.dto.request.customerservice.CsCounselTemplateInfoRequest;
import com.enbiz.api.bo.app.dto.response.customerservice.CsCounselTemplateInfoResponse;
...
public interface CsCnslTmplInfoMapper {
	 ...
	 * @return
	 */
	List<CsCounselTemplateInfoResponse> getCsCnslTmplInfoPopupList(
			CsCounselTemplateInfoRequest CsCounselTemplateInfoRequest);
	 ...
	 * @return
	 */
	List<CsCounselTemplateInfoResponse> getCsCnslTmplInfoList(
			CsCounselTemplateInfoRequest CsCounselTemplateInfoRequest);
	 ...
	 * @return
	 */
	List<CsCounselTemplateInfoResponse> getCsCnslTmplInfoSelectBoxList(
			CsCounselTemplateInfoRequest CsCounselTemplateInfoRequest);
