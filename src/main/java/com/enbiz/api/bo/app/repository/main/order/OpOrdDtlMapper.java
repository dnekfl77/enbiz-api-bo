...
import com.enbiz.api.bo.app.dto.request.delivery.FullOrderRequest;
import com.enbiz.api.bo.app.dto.request.delivery.IndividualSendInstructRequest;
import com.enbiz.api.bo.app.dto.response.delivery.FullOrderResponse;
import com.enbiz.api.bo.app.dto.response.delivery.IndividualSendInstructResponse;
import com.enbiz.api.bo.app.entity.LoDeliDtl;
import com.enbiz.api.bo.app.entity.OpOrdDtl;
...
public interface OpOrdDtlMapper {
	 ...
	 * @return
	 */
	List<IndividualSendInstructResponse> getIndividualSendInstructList(
			IndividualSendInstructRequest individualSendInstructRequest);
