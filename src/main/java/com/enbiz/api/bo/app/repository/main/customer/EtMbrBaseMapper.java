...
import com.enbiz.api.bo.app.dto.request.popup.MemberSearchRequest;
import com.enbiz.api.bo.app.dto.response.customer.CustomerDeliveryInfoResponse;
import com.enbiz.api.bo.app.dto.response.customer.CustomerDetailOrderCallCountResponse;
...
import com.enbiz.api.bo.app.dto.response.customer.CustomerNoMaskingResponse;
...
import com.enbiz.api.bo.app.dto.response.customer.WatchCustomerResponse;
import com.enbiz.api.bo.app.dto.response.customer.WatchCustomerSearchResponse;
import com.enbiz.api.bo.app.dto.response.popup.MemberSearchResponse;
...
public interface EtMbrBaseMapper {
	...
	List<WatchCustomerSearchResponse> getWatchCustomerSearchByViewConditionData(
			CustomerSearchRequest customerSearchRequest);

	CustomerDetailOrderCallCountResponse getCustomerDetailOrderCallCountByMemberNo(
			CustomerDetailRequest customerDetailRequest);
